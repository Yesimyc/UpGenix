            ...
            switch (browser) {
                ...
                case "remote_chrome":
                    try {
                        ...
                        driverPool.set(new RemoteWebDriver(new URL("http://ec2-18-233-224-1.compute-1.amazonaws.com:4444/wd/hub"), chromeOptions));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
                ...
                case "remote_firefox":
                    try {
                        ...
                        driverPool.set(new RemoteWebDriver(new URL("http://ec2-18-233-224-1.compute-1.amazonaws.com:4444/wd/hub"), desiredCapabilities));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
                ...
                //http://ec2-18-212-156-23.compute-1.amazonaws.com:4444/
                // http://ec2-54-166-190-92.compute-1.amazonaws.com:4444/wd/hub  powerfull server of vasyl
            }
        }
